...
class RNAConverterNoOmega():
    ...
    def __build_cord(self, resd_name, fram, fmsk, angl, amsk):
        ...
        for idx_rgrp, rgrp_name_curr in enumerate(rgrp_names_all):
            # rgrp_name_curr - ['angl_0', 'angl_1', 'angl_2', 'angl_3']
            # idx_rgrp       -     0       1        2         3  

            if rgrp_name_curr in ['angl_0', 'angl_1']:  # all these rigid-groups have their orientations w.r.t. the main frame
                rgrp_name_prev = 'main'
